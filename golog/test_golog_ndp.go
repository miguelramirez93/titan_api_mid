...
func CargarReglasDP(reglas string, informacion_cargo []models.DocenteCargo, dias_trabajados float64, periodo string, puntos string, regimen string) (rest []models.Respuesta) {
